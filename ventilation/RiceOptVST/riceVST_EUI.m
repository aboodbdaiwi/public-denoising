...
% else
     EUI_data(Efz_data>maxEfz)=sigma_data*((Efz_data(Efz_data>maxEfz)-a).^2)./sqrt((Efz_data(Efz_data>maxEfz)-a).^2+0.5);   %% this is the result of the two lines above (the eq. under eq (17) in the ISBI2011 paper)
% end
