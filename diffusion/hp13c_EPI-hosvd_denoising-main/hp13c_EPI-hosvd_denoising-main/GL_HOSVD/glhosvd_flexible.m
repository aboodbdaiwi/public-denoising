...
%----------------------------------------------------
% Date: Nov 25th 2020
% made patch size, step size, and search window size variables
% by Yaewon Kim 
function  im_out=glhosvd_flexible(I_noisy,nsig,kglobal,klocal, patchsize, step, sw)
% im_r,std_list,kglobal,klocal,patchsize
time0         =   clock;
nim           =   I_noisy;
% variable - patch  & sw & step size
b             =   patchsize; % block size
[h  w ch]     =   size(nim);
